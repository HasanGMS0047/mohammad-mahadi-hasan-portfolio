...
import { ArrowDown, Blocks, Swords } from "lucide-react";
        ...
        >
          <div className="relative aspect-[4/5] w-full">
            ...
            <motion.div
              ...
              className="stamp absolute -left-6 top-8 flex items-center gap-2 bg-paper px-4 py-2.5"
            >
              <Blocks size={16} className="text-blue" />
              <span className="text-xs font-bold uppercase tracking-widest">Blockchain</span>
            </motion.div>

            <motion.div
              animate={{ y: [0, 10, 0] }}
              transition={{ duration: 6, repeat: Infinity, ease: "easeInOut", delay: 0.5 }}
              className="stamp absolute -right-4 bottom-10 flex items-center gap-2 bg-yellow px-4 py-2.5 text-ink"
            >
              <Swords size={16} />
              <span className="text-xs font-bold uppercase tracking-widest">Chess Player</span>
            </motion.div>
          </div>
        </motion.div>
      </div>
